package com.gsntec.taskapplication.sql;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setMobileNumber(cursor.getString(cursor.getColumnIndex(COLUMN_USER_MOBILE_NUMBER)));
    ...
    public boolean checkUser(String mobile_number) {
        ...
        // selection argument
        String[] selectionArgs = {mobile_number};
     ...
     * @return true/false
     */
    public boolean checkUser(String mobile_number, String password) {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        // selection criteria
        String selection = COLUMN_USER_MOBILE_NUMBER + " = ?" + " AND " + COLUMN_USER_PASSWORD + " = ?";

        // selection arguments
        String[] selectionArgs = {mobile_number, password};
